...
events_base <- tibble(when = c("11/23/2015 09:00 AM", "01/19/2016 09:45 AM", 
                               "01/28/2016 02:00 PM", "07/07/2017 10:00 AM",
                               "01/02/2018 10:00 AM", "02/25/2019 05:30 AM",
                               "10/25/2020 01:30 PM"), 
                      what = c("Young", "Mohs", "Persing", "Close", "Close", "ER", "ER"),
                      type = "systolic")
...
chart_meanperday <- chart_meanperday + scale_x_datetime(date_breaks = "4 months", date_minor_breaks = "1 months", labels = month_year)
...
```{r bp_per_day_recent}
cutoff <- max(bp_group4$when, na.rm = TRUE) - days(180)
...
chart_meanperday_recent <- chart_meanperday_recent + geom_point() + facet_wrap(~ type, ncol = 1, scales = "free_y") + 
  ggtitle("Mean of Grouped Readings by Day (last 180 days)", subtitle = "green dots indicate in-office vitals") + 
  xlab(NULL) + ylab(NULL) +
