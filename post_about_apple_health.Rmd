...
a partikcular point in time. But there are a number of items
where a quantity is accumulated over a short span of time, for example: steps taken, 
...
of effort on correcting these datetime stamps for movements across time zones.
